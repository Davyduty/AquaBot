...
module.exports = {
    ...
    FOOTER: process.env.FOOTER === undefined ? '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 Davyduty ²⁰²²' : process.env.FOOTER,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 Davyduty ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 Davyduty ²⁰²²' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Davyduty The Wizard' : process.env.BOT_NAME,
